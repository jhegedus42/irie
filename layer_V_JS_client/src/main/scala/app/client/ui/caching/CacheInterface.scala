...
import app.client.ui.caching.localState.{ClientSideStateContainer, ClientSideStateContainingMap}
import app.client.ui.caching.localState.TypedRefToClientState._
import app.client.ui.caching.viewCache.SumIntViewCache
import app.client.ui.components.mainPageComponents.components.cacheTestMainPageComp.AddTheThieveryNumbersUsingTheServer
...
class CacheInterface() {
  ...
  val clientStateThieveryNumber: ClientSideStateContainingMap[AddTheThieveryNumbersUsingTheServer.TheThieveryNumber] =
