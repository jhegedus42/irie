...
import app.server.httpServer.routes.logic.typeSafePersistenceHeaven.typelessHell.stupidPersistentActor.Responses.{GetFullApplicationState_Command_Response, UpdateEntity_Command_Response}
import app.server.httpServer.routes.logic.typeSafePersistenceHeaven.typelessHell.stupidPersistentActor.commands.{GetFullApplicationState_Command, InsertNewEntity_Command, ShutdownActor_Command, UpdateEntity_Command}
import app.server.httpServer.routes.logic.typeSafePersistenceHeaven.typelessHell.stupidPersistentActor.events.{CreateEntityEventToBeSavedToTheJournal, UpdateEntityEventToBeSavedToTheJournal}
import app.server.httpServer.routes.logic.typeSafePersistenceHeaven.typelessHell.state.refs.UntypedRef
import app.server.httpServer.routes.logic.typeSafePersistenceHeaven.typelessHell.state.{ApplicationStateMap, ApplicationStateMapContainer, ApplicationStateMapEntry, StateChange}
...
private[stupidPersistentActor] class PersistentActorForOurApp(id: String )
