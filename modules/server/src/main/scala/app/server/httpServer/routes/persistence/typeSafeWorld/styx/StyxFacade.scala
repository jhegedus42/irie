...
import app.server.httpServer.routes.persistence.typeSafeWorld.styx.typelessUnderWorld.state.{ApplicationStateMapEntry, StateChange}
...
/**
  ...
  *
  */
private[typeSafeWorld] case class StyxFacade(
