...
import app.server.httpServer.routes.persistence.notTypeSafeWorld.state.helperUtilsForTesting.TestApplicationState
...
private [notTypeSafeWorld] case class ApplicationStateMapContainer() {
