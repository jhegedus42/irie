...
object UntypedEntity {
  ...
  implicit def makeFromEntity[V <: EntityValue[V]](e: EntityWithRef[V])(
...
//    val entityAsString: EntityAndItsValueAsJSON = e.entityAsJSON()
    val entityValueAsString: EntityValueAsJSON = EntityValue.getAsJson(e.entityValue)
    UntypedEntity(utr, entityValueAsString)
//    UntypedEntity(utr, entityAsString,entityValueAsString)
  }

  def getTypedEntity[V<:EntityValue[V]]:EntityWithRef[V]={
