...
/**
  ...
  * [[Stream.listen(handler:A=>Unit):client.sodium\.Listener* Stream.listen(A=>Unit)]].
  */
abstract class Listener {
  ...
  /**
    * Combine listeners into one so that invoking [[Listener.unlisten()* unlisten()]] on the returned
